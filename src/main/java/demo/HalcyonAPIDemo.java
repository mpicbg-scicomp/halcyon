...
public class HalcyonAPIDemo extends Application
{
	...
	public void demo() throws InvocationTargetException, InterruptedException
	{
		...
		final HalcyonNode lLaser1 = HalcyonNode.wrap( "Laser-1", DemoType.ONE, new VBox(  ) );

		final HalcyonNode lLaser2 = HalcyonNode.wrap( "Laser-2", DemoType.ONE, new VBox(  ) );

		final HalcyonNode lCamera = HalcyonNode.wrap( "Camera-1", DemoType.TWO, new VBox(  ) );

		final HalcyonNode lStage1 = HalcyonNode.wrap( "Stage-1", DemoType.THREE, new VBox(  ) );
