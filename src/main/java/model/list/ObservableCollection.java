...
{
	/** observers of this repository, will be informed whenever items are added or removed */
	...
	/**
	 * Gets the first item with the {@link Object#toString() name} <code>name</code>.
